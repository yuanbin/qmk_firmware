...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	_______, _______, _______, _______, _______, _______, _______,
	_______, KC_Q,     LT(3,KC_W),     LT(2,KC_E),     LT(5,KC_R), KC_T,  _______,
	_______, KC_Y,     LT(5,KC_U),     LT(2,KC_I),     LT(3,KC_O), KC_P,  _______,
	MT(MOD_LSFT, KC_ESCAPE),MT(MOD_LSFT, KC_A),MT(MOD_LALT, KC_S),MT(MOD_LCTL, KC_D),LT(1,KC_F),     LT(4,KC_G),     SW_WIN,
	...
	_______, ST_MACRO_HOME_DIR,     KC_BSLS,        KC_ASTR,        KC_SLASH,       KC_QUES,
	...
	_______, _______, _______, _______, _______, _______, _______,
	_______, _______, _______, _______, _______, _______, _______,
	_______, _______, KC_MS_WH_LEFT,  KC_MS_UP,       KC_MS_WH_RIGHT, _______, _______,
	_______, _______, KC_F7,          KC_F8,          KC_F9,          _______, _______,
	_______, KC_MS_WH_UP,    KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_MS_WH_DOWN,  _______,
