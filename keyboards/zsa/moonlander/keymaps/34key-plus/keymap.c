...
#define __EMPTY_NO_L4__ _______, _______, _______, KC_NO, _______
#define __EMPTY_NO_R4__ _______, KC_NO, _______, _______, _______
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	_______, __EMPTY_NO_L4__, __EMPTY_NO_R4__, _______,
